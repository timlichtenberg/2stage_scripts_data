...
Mce = 9.393e+23      # Mass of Ceres 		   [g]
Mma = 6.4171e+26 	 # Mass of Mars 		   [g]
...
dab = 3.0*au         # Distance asteroid belt  [cm]
dma = 1.523679*au    # Distance Mars-Sun       [cm]
dtack = 2.0*au       # Grand Tack turnover?    [cm] Brasser+16 <- careful!
