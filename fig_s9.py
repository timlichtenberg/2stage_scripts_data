...
lw_mig = 1.5
mig_col_resI        = qred
mig_col_resI_lost   = qred
mig_col_resII       = qblue
mig_col_resII_lost  = qblue
...
for idx, mig_file_name in enumerate([ '750000.0yr1.0Mearth10au', '750000.0yr10.0Mearth10au', '750000.0yr100.0Mearth10au' ]):
    ...
    if idx == 0:
        ...
        ax0.scatter(planet_time[0], planet_orbit[0], color=qred, zorder=10, label=time_print+" Myr, "+orbit_print+" au", s=100, ec="k")

    ax0.plot(planet_time, planet_orbit, color=qred, linestyle='-', lw=lw_mig, zorder=9)

ax0.text(0.67, 1, r'100 $M_\mathrm{Earth}$', color=qred, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
for idx, mig_file_name in enumerate([ '1300000.0yr10.0Mearth17au', '1300000.0yr100.0Mearth17au', '1300000.0yr1.0Mearth17au' ]):
    ...
    if idx == 0:
        ...
        print("Mass mars:", mass_print)
        print("au:", orbit_print)
        ax0.scatter(planet_time[0], planet_orbit[0], color=qblue, zorder=10, label=time_print+" Myr, "+orbit_print+" au", s=100, ec="k")
...
ax0.text(1.53, 1.5, r'10 $M_\mathrm{Earth}$', color=qblue_light, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
for idx, mig_file_name in enumerate([ '2500000.0yr10.0Mearth80au', '2500000.0yr50.0Mearth80au' ]):
    ...
    if idx == 0:
        ...
        print("Mass mars:", mass_print)
        print("au:", orbit_print)
        ax0.scatter(planet_time[0], planet_orbit[0], color=qyellow, zorder=10, label=time_print+" Myr, "+orbit_print+" au", s=100, ec="k")
    ax0.plot(planet_time, planet_orbit, color=qyellow, linestyle='-', lw=lw_mig, zorder=9)

ax0.text(2.31, 8, r'50 $M_\mathrm{Earth}$', color=qyellow_light, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax0.text(3.00, 6, r'10 $M_\mathrm{Earth}$', color=qyellow_light, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
for idx, mig_file_name in enumerate([ '2000000.0yr150.0Mearth90au' ]):
    ...
    if idx == 0:
        ...
        print("Mass mars:", mass_print)
        print("au:", orbit_print)
        ax0.scatter(planet_time[0], planet_orbit[0], color=qmagenta, zorder=10, label=time_print+" Myr, "+orbit_print+" au", s=100, ec="k")
        ax0.scatter(planet_time[-1], planet_orbit[-1]-1.5, marker='s', color=qmagenta, zorder=10, ec="k")
    ax0.plot(planet_time, planet_orbit, color=qmagenta, linestyle='--', lw=lw_mig, zorder=9)
    
ax0.text(1.78, 70, r'150 $M_\mathrm{Earth}$', color=qmagenta, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
for idx, track_names in enumerate([ ('400000.0yr0.01Mearth3.0au', '400000.0yr0.1Mearth3.0au'), ('600000.0yr0.1Mearth7.0au', '600000.0yr0.2Mearth7.0au') , ('2000000.0yr0.01Mearth2.0au', '2000000.0yr0.2Mearth2.0au') ]):
    ...
    ax1.scatter(planet_time[0], planet_orbit[0], color=mig_col_dot, zorder=10, s=50, label=time_print+" Myr, "+orbit_print+" au, "+mass_min+r"$\leq m_\mathrm{embryo}\leq$"+mass_max+r" $M_\mathrm{Earth}$", ec="k")
...
clb = plt.colorbar(CS, cax=cax, ticks=color_ticks, ticklocation="left") # , orientation="horizontal"
...
for idx, mig_file_name in enumerate([ '750000.0yr10.0Mearth10.0au', '1300000.0yr10.0Mearth17.0au', '2500000.0yr10.0Mearth80.0au' ]):
    ...
    print("Mass mars:", mass_print)
    print("au:", orbit_print)
    ax2.scatter(planet_time[0], planet_orbit[0], color=qblue, zorder=20, label=time_print+" Myr, "+orbit_print+" au", s=100, ec="k")
    ...
    ax2.plot(planet_time3, planet_orbit3, color=qblue, linestyle=':', lw=lw_mig, zorder=11)

ax2.text(0.75, 13, r'10 $M_\mathrm{Earth}$', color=qblue, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax2.text(1.3, 23, r'10 $M_\mathrm{Earth}$', color=qblue, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax2.text(2.23, 80, r'10 $M_\mathrm{Earth}$', color=qblue, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
for idx, mig_file_name in enumerate([ '400000.0yr0.1Mearth3.0au', '600000.0yr0.2Mearth7.0au', '2000000.0yr0.2Mearth2.0au']):
    ...
    print("Mass mars:", mass_print)
    print("au:", orbit_print)
    ax2.scatter(planet_time[0], planet_orbit[0], color=qred, zorder=20, label=time_print+" Myr, "+orbit_print+" au", s=50, ec="k")
    ...
    ax2.plot(planet_time3, planet_orbit3, color=qred, linestyle=':', lw=lw_mig, zorder=11)

ax2.text(0.355, 3, r'0.1 $M_\mathrm{Earth}$', color=qred, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax2.text(0.53, 7, r'0.2 $M_\mathrm{Earth}$', color=qred, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax2.text(1.77, 2, r'0.2 $M_\mathrm{Earth}$', color=qred, rotation=0, ha="center", va="center", fontsize=fsize-7, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
...
ax1.scatter([5], [1.524], color=qgray_dark, s=80, zorder=20)
ax1.scatter([5], [1.0], color=qgray_dark, s=130, zorder=20)
ax1.scatter([5], [0.732], color=qgray_dark, s=130, zorder=20)
ax1.scatter([5], [0.39], color=qgray_dark, s=70, zorder=20)
...
ax0.text(xloc_left2, yloc_center, 'Reservoir II, giant planet cores', color="k", rotation=0, ha="left", va="center", fontsize=fsize, transform=ax0.transAxes, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax1.text(xloc_left2, yloc_center, 'Reservoir I, rocky protoplanets', color="k", rotation=0, ha="left", va="center", fontsize=fsize, transform=ax1.transAxes, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
ax2.text(xloc_left2, yloc_center, 'Viscosity ratio sensitivity', color="k", rotation=0, ha="left", va="center", fontsize=fsize, transform=ax2.transAxes, bbox=dict(fc='white', ec="white", alpha=0.01, pad=0.1, boxstyle='round'))
