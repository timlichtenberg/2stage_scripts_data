...
RUN_LIST       = [ 
                    "r010t030al05250fe01150tmp150",
                    "r030t030al05250fe01150tmp150",
                    "r300t030al05250fe01150tmp150",
                    "r100t143al05250fe01150tmp150", 
                    "r100t072al05250fe01150tmp150", 
                    "r100t030al05250fe01150tmp150",
...
plt.ylabel(r"Retained hydrous phases, $f_{\mathrm{hydr}}$ (vol%)", fontsize=fsize+5)
plt.xlabel(r"Time after CAIs, $\Delta t_\mathrm{CAI}$ (Myr)", fontsize=fsize+5)

figure_name="fig_s4b"+".pdf"
